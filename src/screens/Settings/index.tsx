import { ArrowRight2, Award, BookSaved, DiscountShape, Global, Moon, Security, Warning2 } from "iconsax-react-native"
...
const Settings: React.FC = () => {
    ...
    return (
        <>
                ...
                <ScrollView className=" " showsVerticalScrollIndicator={false}>
                    <View className="bg-white  shadow-black rounded-xl w-full flex py-5 justify-start">
                        <View className="flex items-center justify-center gap-y-2">
                            ...
                            <View className="flex justify-center items-center">
                                <View>
                                    <Text className="text-lg font-bold text-black">Ricardo Monteiro</Text>
                                </View>
                                <View>
                                    <Text className="text-md font-normal text-gray-300">rick.dev@gmail.com</Text>
                                </View>
                            </View>
                        </View>
                    ...
                    <View className="w-full gap-y-2 mt-2">
                        <View className="w-full shadow-xl shadow-black">
                            ...
                            <TouchableOpacity activeOpacity={0.6} className="bg-white py-2 px-3">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center gap-x-2">
                                        <BookSaved size="25" color="#0009" variant="Bulk" />
                                        <Text className="text-sm font-semibold">Notícias Salvas</Text>
                                    </View>
                                    <View>
                            ...
                            <TouchableOpacity activeOpacity={0.6} className="bg-white rounded-b-md py-2 px-3">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center gap-x-2">
                        ...
                        <View className="w-full shadow-xl shadow-black">
                            ...
                            <TouchableOpacity activeOpacity={0.6} className="bg-white py-2 px-3">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center gap-x-2">
                                        ...
                                        <Text className="text-sm font-semibold">Gerenciar Nível</Text>
                                    </View>
                                    <View>
                                        <ArrowRight2 size="25" color="#0006" variant="Bulk" />
                                    </View>
                            ...
                            <TouchableOpacity activeOpacity={0.6} onPress={() => showDarkSettings()} className="bg-white py-2 px-3">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center gap-x-2">
                            ...
                            <TouchableOpacity activeOpacity={0.6} className="bg-white rounded-b-md py-2 px-3">
                                <View className="flex flex-row items-center justify-between">
                                    <View className="flex flex-row items-center gap-x-2">
                                        ...
                                        <Text className="text-sm font-semibold">Política de Privacidade</Text>
                                    </View>
                                    <View>
                                        <ArrowRight2 size="25" color="#0006" variant="Bulk" />
                                    </View>
            ...
            <Modal backdropTransitionOutTiming={0} onBackdropPress={closeDarkSettings} onSwipeComplete={closeDarkSettings} onBackButtonPress={closeDarkSettings} isVisible={isDarkSettingsVisible} swipeDirection="down" className='m-0 flex-1 justify-end' >
                <View className='rounded-t-3xl bg-background-light transition-colors delay-100 ease-in flex p-5 h-[60%]'>
