export const SwiperData = [
    ...
    },
    {
        ...
        imagePath: 'https://www.ilustradafm.com.br/wp-content/uploads/2020/07/Sorteio-de-Dia-dos-Pais.jpeg',
...
export const Promotions = [
    ...
    {
        id: 2,
        title: "Sorteio Iphone 14 Pro Max",
        imagePath: "https://gmvpremiacoes.com.br/wp-content/uploads/2023/03/IMG-20230308-WA0007.jpg",
        dateReleased: "10. Out ás 12:00",
        Level: {
            id: 1,
            name: 'Ouro',
            imagePath: ''
    ...
    },
    {
        ...
        imagePath: "https://www.liderfm879.com.br/tim.php?src=/uploads/images/2022/05/promocao-aniversariante-do-mes.jpg&w=1300&h=720",
        Level: {
            id: 1,
            name: 'Bronze',
            imagePath: ''
...
export const categoryNews = [
    { index: 0, name: 'Novidades' },
    { index: 1, name: 'Esportes' },
    { index: 2, name: 'Tecnologia' },
    { index: 3, name: 'Saúde' },
    { index: 4, name: 'Política' },
    { index: 5, name: 'Filmes' },
    { index: 6, name: 'Cultura' },
    { index: 7, name: 'Televisão' },
    { index: 8, name: 'Cotidiano' },
]
